...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url('/dashboard'); ?>" class="brand-link">
    <img src="<?= base_url(); ?>/assets/vendor/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?= base_url(); ?>/assets/vendor/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
          alt="User Image">
      </div>
      <div class="info">
        <a href="#" class="d-block"><?= $session->get('namauser'); ?></a>
        <span class="right badge badge-danger"><?= $session->get('idlevel'); ?></span>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= base_url('/dashboard2/contact'); ?>" class="nav-link">
            <i class="nav-icon fas fa-th"></i>
            <p>
              Contact
              <span class="right badge badge-danger">New</span>
