        ...
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <div class="row mb-3">
                <div class="col-md-10">
                  <a href="/lakip/edit/<?= $lakip['slug']; ?>" class="btn btn-warning">Edit</a>
                  <?= csrf_field(); ?>
                  <form action="/lakip/<?= $lakip['id']; ?>" method="POST" class="d-inline">
                    <input type="hidden" name="_method" value="DELETE">
                    <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin?');">Delete</button>
                  </form>
                  <a href="/lakip" class="btn btn-info">Back to Daftar</a>
                </div>
              </div>
              <!-- row mb-3 -->
            </div>
